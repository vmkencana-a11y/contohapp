...
class UserSession extends Model
{
    ...
    /**
     * Check if token rotation is needed (every 6 hours).
     */
     ...
     * Revoke the session.
     */
    public function revoke(string $reason = 'user_logout'): void
    {
        $this->update([
            'revoked_at' => now(),
     ...
     */
    public static function revokeAllForUser(string $userId, string $reason = 'forced_logout'): int
    {
