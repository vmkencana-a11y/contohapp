...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('admin.profile.edit') }}" class="text-sm text-gray-500 hover:text-primary-600">
    ...
    <div class="card p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2">Ikuti langkah berikut untuk mengaktifkan 2FA</p>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="ml-11">
                <p class="text-sm text-gray-500 mb-2">Atau masukkan kode manual:</p>
                <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 font-mono text-center text-sm break-all select-all">
                    {{ $secret }}
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <form action="{{ route('admin.profile.2fa.confirm') }}" method="POST" class="ml-11" x-data="{ loading: false }" @submit="loading = true">
                @csrf
        ...
        <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
            <div class="flex gap-3">
                ...
                <div class="text-sm text-amber-700 dark:text-amber-400">
                    <p class="font-medium mb-1">Simpan kode secret!</p>
                    <p>Jika kehilangan akses ke Google Authenticator, Anda memerlukan bantuan super admin untuk reset.</p>
                </div>
            </div>
        </div>
    </div>
