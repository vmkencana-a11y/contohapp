                    ...
                    <tr>
                        <td class="content" style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 14px; line-height: 1.4; color: #4a4a4a;">
                                Berikut adalah kode verifikasi Anda. Gunakan kode ini untuk melanjutkan proses autentikasi.
                            </p>
                            ...
                            <table style="margin: 0 0 20px;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="padding: 20px; background-color: #f8f9fa; border-radius: 8px; text-align: center;">
                                        ...
                                        <p style="margin: 0 0 8px; font-size: 36px; font-weight: 700; letter-spacing: 8px; color: #0f4b80; font-family: 'Courier New', monospace;">
                                            {{ $otp }}
                                        </p>
                                ...
                                <tr>
                                    <td style="padding: 16px; background-color: #FEF3C7; border-left: 4px solid #F59E0B; border-radius: 0 8px 8px 0;">
                                        <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #92400E;">
                                            ...
                                            Tim Sekuota tidak pernah meminta kode verifikasi Anda.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 30px 40px; text-align: center; background-color: #fafafa;">
                            ...
                            <p style="margin: 0 0 8px; font-size: 13px; line-height: 1.5; color: #6b7280;">
                                Email ini dikirim secara otomatis. Jika Anda tidak meminta kode ini, abaikan email ini.
                            </p>
